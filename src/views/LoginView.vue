      ...
      <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div class="w-full">
            ...
            <hr class="my-8" />
            <router-link class="text-blue-600" to="/reset">Reset Password</router-link>
            <hr class="my-8" />
            <router-link class="text-blue-600" to="/register">Don't have an account? Signup Now</router-link>
    ...
    methods: {
        login() {
            ...
            this.$store.dispatch('Auth/login', this.form).then(response => {
                ...
                let msg = this.$store.getters['Auth/msg'];
